...
public class Simulation extends ApplicationAdapter implements InputProcessor {
	...
	private World world;
	MyMapRenderer tiledMapRenderer;
	...
	public void create () {
		...
		*/
		...
		try {
			controllerField = World.class.getDeclaredField("controller");
			controllerField.setAccessible(true);
			controller = (CarController) controllerField.get(world);
		...
		tiledMapRenderer = new MyMapRenderer(map,unitScale, world.getCar(), controller);
